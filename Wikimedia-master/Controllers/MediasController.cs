...
public class MediasController : Controller
{
    ...
    private void InitSessionVariables()
    {
        ...
        if(Session["CurrentMedia"] == null) Session["CurrentMedia"] = null;
    ...
    {
        if(Session["CurrentMedia"] != null)
            if(Session["CurrentMedia"] != DB.Medias.Get((int)Session["CurrentMediaId"]) || forceRefresh)
            {
                Session["CurrentMedia"] = DB.Medias.Get((int)Session["CurrentMediaId"]);
                return PartialView(Session["CurrentMedia"]);//View();// Details((int)Session["CurrentMediaId"]);
            }
        return null;
    }
